    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @php
                        ...
                        $greeting = '';
                        if ($hour < 12) {
                            $greeting = 'Bom dia'; // Good morning
                        } elseif ($hour < 18) {
                            $greeting = 'Boa tarde'; // Good afternoon
                        } else {
                ...
                <div
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="text-2xl font-bold mb-4 flex items-center">
                            <svg class="h-8 w-8 text-indigo-600 mr-2" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-1 10a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2h12a2 2 0 012 2v10z" />
                            </svg>
                            ...
                            @if ($unreadAdminMessagesCount > 0)
                                <span
                                    class="ml-2 px-3 py-1 text-sm font-semibold rounded-full bg-red-500 text-white dark:bg-red-700">
                                    {{ $unreadAdminMessagesCount }} não
                                    lida{{ $unreadAdminMessagesCount > 1 ? 's' : '' }}
                                </span>
                            @endif
                        </h3>

                        @if ($adminMessages->isEmpty())
                            <p class="text-gray-600 dark:text-gray-400">Não há mensagens recebidas para o administrador.
                            </p>
                        @else
                            <div class="overflow-x-auto mb-4">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($adminMessages->take(5) as $message)
                                            {{-- Show more admin messages if desired --}}
                                            <tr
                                                class="{{ is_null($message->read_at) ? 'font-bold bg-blue-50 dark:bg-blue-900/20' : 'text-gray-600 dark:text-gray-300' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('messages.show', $message->id) }}"
                                                        class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200">Ver
                                                        Mensagem</a>
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-2xl font-bold mb-4 flex items-center">
                        <svg class="h-8 w-8 text-gray-600 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-1 10a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2h12a2 2 0 012 2v10z" />
                        </svg>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($userBookings->isEmpty())
                        <p class="text-gray-600 dark:text-gray-400">Ainda não tem reservas. Que tal explorar os nossos
                            <a href="{{ route('bungalows.index') }}"
                                class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200 underline">bungalows</a>?
                        </p>
                    @else
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach ($userBookings as $booking)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('bungalows.show', $booking->bungalow_id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-200 mr-4">Ver
                                                    Bungalow</a>
                                                @if ($booking->status === 'paid')
                                                    <a href="{{ route('bookings.invoice.download', $booking) }}"
                                                        class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-200">Download
                                                        Fatura</a>
                                                @endif
                                            </td>
                                        </tr>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('contact.admin') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="subject"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Assunto:</label>
